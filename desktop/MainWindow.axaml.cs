...
public partial class MainWindow : Window
{
    ...
    private void SetSelectedImagePreview(Image preview, TextBlock name, Button clearButton, string? relativePath, ref Bitmap? bitmapField, ref string? pathField)
    {
        bitmapField?.Dispose();
        bitmapField = null;
    ...
    {
        SetSelectedImagePreview(SelectedImagePreview, SelectedImageNameText, ClearImageButton, null, ref _selectedImageBitmap, ref _selectedImagePath);
    }

    private void ClearEditImageSelection()
    {
        SetSelectedImagePreview(EditSelectedImagePreview, EditSelectedImageNameText, EditClearImageButton, null, ref _editSelectedImageBitmap, ref _editSelectedImagePath);
    }
    ...
    private async Task SelectImageAsync(bool editing)
    {
        ...
        if (editing)
        {
            SetSelectedImagePreview(EditSelectedImagePreview, EditSelectedImageNameText, EditClearImageButton, importedPath, ref _editSelectedImageBitmap, ref _editSelectedImagePath);
        }
        else
        {
            SetSelectedImagePreview(SelectedImagePreview, SelectedImageNameText, ClearImageButton, importedPath, ref _selectedImageBitmap, ref _selectedImagePath);
        }
    }
    ...
    private void EditPost_Click(object? sender, RoutedEventArgs e)
    {
        ...
        {
            SetSelectedImagePreview(EditSelectedImagePreview, EditSelectedImageNameText, EditClearImageButton, post.ImagePath, ref _editSelectedImageBitmap, ref _editSelectedImagePath);
        }
